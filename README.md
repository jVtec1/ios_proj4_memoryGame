...
Submitted by: **Andy Espinoza**

**Memory Game** is an app that allows a user to pick a number of cards to chose from, is they chose a matching pair, the cards disappear until all cards are matched
...
[Guide](https://youtu.be/l1GwTBRq30Y) .
